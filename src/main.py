...
class PairSelection:
    ...
    def dimensionality_reduction(self, num_features = 10):
        if self.prices_df is None:
            raise Exception("Please input a valid price series before running this method.")
        ...
        pca.fit_transform(scaled_returns_df)
    ...
    def plot_clustering_info(self, n_dimensions: int = 2, method: str = "", figsize: tuple = (10, 10)) -> Axes:
        """
    ...
    def _generate_pairwise_combinations(self, labels: list) -> list:
        # TODO: quickly reasses this function
        """
